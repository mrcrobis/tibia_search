...
# pesquisa o segundo item (item grand sanguine e enchanted ring/amulet aparece primeiro)
items_secundarios_a_pesquisar = []

soulcores_a_pesquisar = []
